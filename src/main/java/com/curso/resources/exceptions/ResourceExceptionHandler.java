...
import com.curso.services.exceptions.AuthorizationException;
import com.curso.services.exceptions.DataIntegrityException;
import com.curso.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e, HttpServletRequest request){
		...
		StandardError err= new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro de dados", e.getMessage(), request.getRequestURI());
